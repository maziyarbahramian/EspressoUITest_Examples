...
import com.mazibahrami.espresso.databinding.LayoutMovieListItemBinding
...
class MoviesListAdapter(private val interaction: Interaction? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return MovieViewHolder(itemBinding, interaction)
    }
    ...
    constructor(
        private val itemBinding: LayoutMovieListItemBinding,
        ...
        fun bind(item: Movie) {
            ...
            item.star_actors?.let {
                for (index in 0 until it.size) {
                    ...
                    itemBinding.movieStarActors.append(appendValue)
                }
            }
        }
    }
